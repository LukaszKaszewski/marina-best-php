 ...
 */
final class Version20240215211159 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE place ADD CONSTRAINT FK_741D53CDA1E84A29 FOREIGN KEY (boat_id) REFERENCES place (id)');
